package com.ponsun.san.arabicSan.api;

import com.ponsun.san.arabicSan.data.ResponseData;
import com.ponsun.san.arabicSan.data.UiReciveSingleRecordDto;
import com.ponsun.san.arabicSan.data.UiSanctionSearchRequest;
import com.ponsun.san.arabicSan.service.FileService;
import com.ponsun.san.arabicSan.service.UiReciveSingleRecord;
import com.ponsun.san.arabicSan.service.UiReciveSingleRecordService;
...
public class UiReciveSingleRecordApiResources {
    ...
    ///////////////
    @GetMapping("/SanctionsAlSearch")
    List<ResponseData> getSanctionsAlSearch(MultiParaSearchData multiParaSearchData){
        return this.uiReciveSingleRecordService.getAlgorithmRecords(multiParaSearchData);
    }
    ////////////////
